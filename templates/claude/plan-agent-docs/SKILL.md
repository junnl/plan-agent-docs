...
argument-hint: "[--plan <file>] [--force] [--dry-run]"
allowed-tools: Bash(plan-agent-docs generate *)
---
...
2. If the command failed because no plan exists, suggest rerunning with `/plan-agent-docs --force` or `/plan-agent-docs --plan <file>`.
